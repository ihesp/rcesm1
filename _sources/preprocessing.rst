...
1. Determine the extents of the WRF and ROMS model domains.
...
2. Generate the WRF atmosphere grid, initial and boundary conditions using WRF pre-processing tools. Then generate the domain file for the atmosphere. Follow the steps in the `WRF preprocessing tutorial <wrf_grid.rst>`__

3. Generate the ROMS ocean grid, and the intial, boundary conditions and nudging files. Follow the steps outlined in the `ROMS preprocessing tutorial <roms_grid.rst>`__.
